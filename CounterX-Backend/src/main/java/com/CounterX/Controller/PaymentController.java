...
public class PaymentController {
    ...
    public ResponseEntity<?> createRazorpayOrder(
        ...
        // Math.round instead of (int) cast: avoids floating point
        // truncation (e.g. 53.1 * 100 can come out as 5309.999999...
        // and a raw int cast would chop that down to 5309 paise).
