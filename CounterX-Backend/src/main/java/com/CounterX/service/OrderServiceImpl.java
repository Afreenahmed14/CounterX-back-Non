...
public class OrderServiceImpl implements OrderService {
    ...
    public Order placeOrder(OrderDto orderDTO) {
        ...
        // totalAmount: frontend sends as "total"; @JsonAlias maps it correctly.
        // Defensive fallback to 0.0 - the column is NOT NULL, so a missing/garbled
        // payload must never reach the DB as a null value (that throws a 500).
        ...
        // Token number is intentionally left null here.
        // It is assigned once payment succeeds (see PaymentServiceImpl.processPayment),
        // so an order can always be created even before payment is confirmed.
